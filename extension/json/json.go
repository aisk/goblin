...
func jsonUnmarshal(args object.CallArgs) (object.Object, error) {
	...
	return ToGoblin(v, "unmarshal")
}

// ToGoblin converts a value decoded by encoding/json (with UseNumber) into
...
func ToGoblin(v any, funcname string) (object.Object, error) {
	switch x := v.(type) {
	case nil:
