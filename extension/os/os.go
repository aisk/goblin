...
// Execute builds the os module with live process arguments (os.Args).
...
// ExecuteWithFrozenArgs builds the os module with a fixed Args snapshot.
...
// returns.
func ExecuteWithFrozenArgs(args []string) (object.Object, error) {
