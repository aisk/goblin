...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `Expression5 : Expression6	<<  >>`,
		Id:         "Expression5",
		NTType:     11,
		Index:      35,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression6 : Expression7	<<  >>`,
		Id:         "Expression6",
		NTType:     12,
		Index:      37,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression6 : Expression6 "[" Expression "]"	<< ast.NewIndexExpression(X[0], X[2]) >>`,
		Id:         "Expression6",
		NTType:     12,
		Index:      38,
		NumSymbols: 4,
	...
	ProdTabEntry{
		String: `Expression7 : IntegerLiteral	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      39,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : FloatLiteral	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      40,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : StringLiteral	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      41,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : TrueLiteral	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      42,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : FalseLiteral	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      43,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : ListLiteral	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      45,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : DictLiteral	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      46,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : FunctionCall	<<  >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      47,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression7 : "(" Expression ")"	<< X[1], nil >>`,
		Id:         "Expression7",
		NTType:     13,
		Index:      49,
		NumSymbols: 3,
