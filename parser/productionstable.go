...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `Expression1 : Expression1 "and" Expression2	<< ast.NewBinaryOperation(X[0], "and", X[2]) >>`,
		Id:         "Expression1",
		NTType:     7,
		Index:      19,
		NumSymbols: 3,
		ReduceFunc: func(X []Attrib, C interface{}) (Attrib, error) {
			return ast.NewBinaryOperation(X[0], "and", X[2])
		},
	},
	ProdTabEntry{
		String: `Expression1 : Expression1 "or" Expression2	<< ast.NewBinaryOperation(X[0], "or", X[2]) >>`,
		Id:         "Expression1",
		NTType:     7,
		Index:      20,
		NumSymbols: 3,
		ReduceFunc: func(X []Attrib, C interface{}) (Attrib, error) {
			return ast.NewBinaryOperation(X[0], "or", X[2])
		},
	},
	ProdTabEntry{
