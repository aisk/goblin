...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `Expression1 : AndExpression	<<  >>`,
		Id:         "Expression1",
		NTType:     9,
		Index:      32,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `Expression1 : Expression1 "||" AndExpression	<< ast.NewBinaryOperation(X[0], "||", X[2]) >>`,
		Id:         "Expression1",
		NTType:     9,
		Index:      33,
		NumSymbols: 3,
	...
	ProdTabEntry{
		String: `AndExpression : Expression2	<<  >>`,
		Id:         "AndExpression",
		NTType:     10,
		Index:      34,
		NumSymbols: 1,
	...
	ProdTabEntry{
		String: `AndExpression : AndExpression "&&" Expression2	<< ast.NewBinaryOperation(X[0], "&&", X[2]) >>`,
		Id:         "AndExpression",
		NTType:     10,
		Index:      35,
		NumSymbols: 3,
